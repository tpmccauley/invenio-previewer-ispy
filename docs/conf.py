...
project = u'Invenio-Previewer-ISPY'
...
htmlhelp_basename = 'invenio-previewer-ispydoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'invenio-previewer-ispy.tex',
     u'Invenio-Previewer-ISPY Documentation',
